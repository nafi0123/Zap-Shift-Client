...
const Register = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <h2 className="text-4xl font-bold mb-2 text-center">Welcome to Zap Shift</h2>
      ...
      <form onSubmit={handleSubmit(handleRegistration)} className="space-y-3">
        ...
        <button className="btn text-black btn-primary w-full mt-2">Register</button>

        <p className="text-sm text-center">
          Already have an account? 
          <Link to="/login" state={location.state} className="text-blue-500 ml-1">Login</Link>
        </p>
      </form>
